...
if __name__ == "__main__":
    ...
    header1 = "test case ; filename ; total similarity difference ; detect manipulated ; detect base" + nl
    f.write(header0)
    f.write(header1)
    for datatype in test_cases:
        ...
        for data in datapaths:
            ...
            file = img_name
            result = f"{case} ; {file} ; {total_diff} ; {detect_manipulated} ; {detect_base}" + nl
            f.write(result)
    f.close()
